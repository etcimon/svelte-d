...
- wasm-eh and Binaryen `--asyncify` do not share a module on Binaryen 132. Do not print `.await` on the default cell. A landing pad and `libwasm_await__void` must not share a function.
