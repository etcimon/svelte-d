...
- Workspace default wasm cell follows **svelte-engine** (`ldc-master` / wasm-eh, copy-raw). Named `ldc-1.36` / `ldc-1.42` remain. 1.43 must not advertise `.await`. (construction of the yield protocol)
